...
class App:
	def __init__(self, master):
		...
		if os.name == 'nt':
			photo = PhotoImage(file="C:\project\images\logo.gif")
		elif os.name == 'posix':
			photo = PhotoImage(file="C:/project/images/logo.gif")
	...
	def genre(self):
		...
		if os.name == 'nt':		
			graph = PhotoImage(file="C:\project\images\pie_genre.gif")
		elif os.name == 'posix':
			graph = PhotoImage(file="C:/project/images/pie_genre.gif")
	...
	def length(self):
		...
		if os.name == 'nt':
			graph = PhotoImage(file="C:\project\images\pie_length.gif")
		elif os.name == 'posix':
			graph = PhotoImage(file="C:/project/images/pie_length.gif")
		lPhoto = Label(top, image=graph)
		lPhoto.image=graph
	...
	def year(self):
		...
		if os.name == 'nt':
			graph = PhotoImage(file="C:\project\images\pie_year.gif")
		elif os.name == 'posix':
			graph = PhotoImage(file="C:/project/images/pie_year.gif")
		lPhoto = Label(top, image=graph)
		lPhoto.image=graph
